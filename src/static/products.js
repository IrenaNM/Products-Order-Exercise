let products = [
    ...
    },
    {
        id: 2,
        name: 'Concrete Bench',
        description: 'Made of concrete, wood and metal, suggested usage is on walking area, parks etc.',
        unit: 'piece',
        ingredients: [
            {
                name: 'concrete',
    ...
    },
    {
        ...
        description: 'Artificial stone, made to create natural feeling in your enterior.',
        unit: 'sq. m',
        ingredients: [
            {
                name: 'concrete',
